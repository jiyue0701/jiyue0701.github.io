...
function fixedRuntimeIssues(plan = guidedWorkoutPlanV2) {
  ...
  if (segments.length !== 25 || calculatePlannedDurationMs(plan) !== 860_000 || plan.plannedDurationMs !== 860_000) issues.push(error('PLAN_DURATION_MISMATCH', '$.plans', 'fixed runtime must remain 25 segments and 860000ms'))
