...
writeAudit('completed-session-v2.json', [
  check('schema-and-timing', () => completed.plannedDurationMs === 860000 && completed.activeElapsedMs === 860000 && completed.wallElapsedMs === 860000, { plannedDurationMs: completed.plannedDurationMs, activeElapsedMs: completed.activeElapsedMs, wallElapsedMs: completed.wallElapsedMs }),
...
writeAudit('personal-plan-runtime.json', [
  check('fixed-plan-sum', () => buildWorkoutSegments(fixedMaterialized).length === 25 && fixedMaterialized.plannedDurationMs === 860000),
